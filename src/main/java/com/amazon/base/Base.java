...
public class Base {
	...
	public Base() {
		if (driver == null) {
			...
			try {
				FileInputStream common_path = new FileInputStream(System.getProperty("user.dir")
						+ "\\src\\main\\java\\com\\amazon\\base\\common_properties.properties");
				common_prop.load(common_path);

				FileInputStream prop_path = new FileInputStream(System.getProperty("user.dir")
						+ "\\src\\main\\java\\com\\amazon\\pages\\chrome_locators.properties");
				prop.load(prop_path);
